...
const Groups = () => {
    ...
    const handleGroupUpdate = async (event) => {
        ...
        const groupWasUpdated = await GroupsService.updateGroup(idToUpdate, updatedGroup);
        setName('');
        setDescription('');
        setIdToUpdate(null);
        setFormIsVisible(false);
        setGroups(groups.map(g => g.id === groupWasUpdated.id ? groupWasUpdated : g));
    }
    ...
    return (
        <>
            ...
            <TableContainer component={Paper}>
                <TableHead>
                    <TableRow>
                        <TableCell>Current groups</TableCell>
                    </TableRow>
                </TableHead>
                <Table>
                    <TableBody>
